package top.zfandlove.util.retrofit;
...
/**
 * Created by zfan on 2017/12/28.
 */

public class SSLManager implements  SSLi{
    protected Context context;
    final String PROTOCOL_TYPE = "TLS";
    private String[] hostnameVerifiers;
    private String assetCertificateName;

    public SSLManager(Context context, String[] hostnameVerifiers, String assetCertificateName) {
